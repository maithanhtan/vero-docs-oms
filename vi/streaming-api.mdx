---
title: 'Streaming API'
description: 'Kênh WebSocket được tạo từ asyncapi.json'
mode: 'wide'
---
...
<CardGroup cols={3}>
  <Card title="Nguồn AsyncAPI" icon="file-code">
    Tham chiếu streaming được tạo từ `asyncapi.json`; docs dùng bản mirror AsyncAPI 3.0 tương thích Mintlify.
  </Card>
