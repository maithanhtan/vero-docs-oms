...
Vero OMS API giúp ứng dụng tích hợp với các quy trình quản lý lệnh của Vero qua REST/JSON endpoints và Centrifugo WebSocket streams.
...
| Mục | Độ phủ |
|---|---|
| REST API | 44 HTTP operations |
| Streaming API | 8 WebSocket channel patterns |
| Xác thực | Login, registration, recovery, settings và session flows |
