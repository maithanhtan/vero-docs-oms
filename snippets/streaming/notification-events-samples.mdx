...
const streamUrl = "wss://api-data-hub.verolabs.co/connection/websocket";
const channel = "order:MarginCall:ACC123456";
...
STREAM_URL = "wss://api-data-hub.verolabs.co/connection/websocket"
channel = "order:MarginCall:ACC123456"
...
func main() {
	streamURL := "wss://api-data-hub.verolabs.co/connection/websocket"
	channel := "order:MarginCall:ACC123456"
...
var streamUrl = new Uri("wss://api-data-hub.verolabs.co/connection/websocket");
var channel = "order:MarginCall:ACC123456";
...
async fn main() -> anyhow::Result<()> {
    let stream_url = "wss://api-data-hub.verolabs.co/connection/websocket";
    let channel = "order:MarginCall:ACC123456";
...
int main() {
    ...
    std::string stream_url = "wss://api-data-hub.verolabs.co/connection/websocket";
    std::string channel = "order:MarginCall:ACC123456";
