...
const channel = "mkt:depth:VN30F1M-G1";
...
var channel = "mkt:depth:VN30F1M-G1";
...
async fn main() -> anyhow::Result<()> {
    ...
    let channel = "mkt:depth:VN30F1M-G1";
...
int main() {
    ...
    std::string channel = "mkt:depth:VN30F1M-G1";
