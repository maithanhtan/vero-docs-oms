...
const channel = "order:Account:ACC123456";
...
channel = "order:Account:ACC123456"
...
var channel = "order:Account:ACC123456";
...
async fn main() -> anyhow::Result<()> {
    ...
    let channel = "order:Account:ACC123456";
...
int main() {
    ...
    std::string channel = "order:Account:ACC123456";
