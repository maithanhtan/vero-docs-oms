...
const channel = "mkt:tradeLog:VN30F1M";
...
var channel = "mkt:tradeLog:VN30F1M";
...
async fn main() -> anyhow::Result<()> {
    ...
    let channel = "mkt:tradeLog:VN30F1M";
...
int main() {
    ...
    std::string channel = "mkt:tradeLog:VN30F1M";
