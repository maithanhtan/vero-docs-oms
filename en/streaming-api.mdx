---
title: 'Streaming API'
description: 'WebSocket channels generated from asyncapi.json'
mode: 'wide'
---
...
<CardGroup cols={3}>
  <Card title="AsyncAPI source" icon="file-code">
    The streaming reference is generated from `asyncapi.json`; docs use a Mintlify-compatible AsyncAPI 3.0 mirror.
  </Card>
